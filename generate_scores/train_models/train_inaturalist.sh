...
# %j is jobid
#SBATCH -o /home/tding/slurm_output/train_inaturalist_job=%j.out # STDOUT
#SBATCH -e /home/tding/slurm_output/train_inaturalist_job=%j.err # STDERR
...
python train.py 'iNaturalist' .5 --num_epochs 1 --min_train_instances 290