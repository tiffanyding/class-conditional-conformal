...
# %j is jobid
#SBATCH -o /home/tding/slurm_output/train_inaturalist_family_job=%j.out # STDOUT
#SBATCH -e /home/tding/slurm_output/train_inaturalist_family_job=%j.err # STDERR
...
python train.py 'iNaturalist' .5 --num_epochs 1 --target_type family